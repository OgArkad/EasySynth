...
1. Click the shield icon in the search bar. ![It's at the left side of your search bar.](media/search_bar.png)
2. Select the "Connection secure" button with a lock icon.
3. Open: "More site information". ![Here you should see what you are expected to open.](media/security.png)
4. Go to the Permissions tab.
5. Scroll down until you find MIDI devices settings. ![The checkboxes before.](media/MIDI_devices_def.png)
6. Unselect the use default checkbox, and click allow, on both of the permissions. ![The checkboxes after.](media/MIDI_devices_allow.png)
