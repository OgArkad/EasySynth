...
export default class MIDI {
    ...
    handleMessage(msg: any){
        if (msg === undefined || this.playSound === undefined || this.releaseSound === undefined) throw new Error("MIDI error: no message to handle, or play/releaseSound was not defined!");
        if (msg[0] === 1)
